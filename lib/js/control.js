...
*/
	...
	*************************************************************************************/
	...
	var footerNewsSlideCount = $('.js-footerSlide').length;

	$('.js-footerSlide').eq(footerNewsSlideNum).addClass('is-active');

	var footerNews = setInterval(footerNextNews,3000);
	...
	function footerNextNews() {
		...
		$('.js-footerSlide').removeClass('is-active');
		$('.js-footerSlide').eq(footerNewsSlideNum).addClass('is-active');
	}


	var owl = $(".js-photoSlider");
	...
	$(function(){
		$('.js_bnt_font_plus').click(function(){
			textSize( $(this) );
		});

		$('.js_bnt_font_minus').click(function(){
			textSize( $(this) );
		});

		function textSize (_this) {
			$('.post_content *').each(function(){
				...
				if(_this.hasClass('js_bnt_font_plus')) {
					finalNum += 2;
				}
				else if (_this.hasClass('js_bnt_font_minus')){
					finalNum -= 2;
				}
