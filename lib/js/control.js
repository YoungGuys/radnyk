...
//	CKEDITOR.replace('editor1');
    ...
    $('.slider').mouseenter(function () {
        clearInterval(slider_go);
    })
    $('.slider').mouseleave(function () {
        slider_go = setInterval(slider, 3000);
    })
    ...
    $('.prev_post_photo').click(function () {
        fn_slide('prev');
    });
    $('.next_post_photo').click(function () {
        fn_slide('next');
    });
    ...
    $('.mod_prev_photo').click(function () {
        fn_mod_slide('prev')
    });
    $('.mod_next_photo').click(function () {
        fn_mod_slide('next')
    });
